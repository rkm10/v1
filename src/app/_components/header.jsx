...
function SocialLinks() {
  return (
    <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
      ...
      <li className="mr-5 shrink-0 text-xs"><Link className="block hover:text-slate-200" href="/images/raj/rajkumar_malluri.pdf" target="_blank" rel="noreferrer noopener" aria-label="Download Resume" title="Download Resume"><span className="sr-only">Resume</span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="h-6 w-6" aria-hidden="true"><path d="M9.7 1H6.3a.7.7 0 0 0-.7.7v4.28H1.7a.7.7 0 0 0-.7.7v7.34a.7.7 0 0 0 .7.7h12.6a.7.7 0 0 0 .7-.7V6.98a.7.7 0 0 0-.7-.7h-3.9V1.7a.7.7 0 0 0-.7-.7zM5.6 1.7a.6.6 0 0 1 .6-.6h4.8a.6.6 0 0 1 .6.6v4.9H5.6V1.7zM1.7 7.28h12.6v5.94H1.7V7.28z"></path></svg></Link></li>
    </ul>
  );
}
  ...
  return (
    <main id="content" className="pt-24 lg:w-1/2 lg:py-24">
      ...
      <section id="experience" className='mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24' aria-label="Work experience">
                ...
                <div className="z-10 sm:col-span-6">
                  ...
                  <>
                    ...
                    <ul className="mt-2 flex flex-wrap" aria-label="Technologies used">
                      ...
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Spectra</div>
                      </li>
                      <li className="mr-1.5 mt-2">
                        <div className="flex items-center rounded-full bg-teal-400/10 px-3 py-1 text-xs font-medium leading-5 text-teal-300 ">Astra</div>
                      </li>
                      <li className="mr-1.5 mt-2">
        ...
        {/* use this div for other Experience */}
        {/* <div>
          <ol className='group/list'>
            <li className='mb-12'>
              <div className='group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
      ...
      <section id='projects' className='mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24' aria-label="Projects">
        ...
        {/* dummy project replace with original */}
